...
ParticleTagAssociationCollection::ParticleTagAssociationCollection() : m_isValid(false), m_collectionID(0), m_entries() , m_rel_Particle(new std::vector<fcc::ConstParticle>()), m_rel_Tag(new std::vector<fcc::ConstTag>()),m_data(new ParticleTagAssociationDataContainer() ) {
    m_refCollections.push_back(new std::vector<podio::ObjectID>());
  m_refCollections.push_back(new std::vector<podio::ObjectID>());

}

ParticleTagAssociationCollection::~ParticleTagAssociationCollection() {
  clear();
