...
TrackHitCollection::TrackHitCollection() : m_isValid(false), m_collectionID(0), m_entries() ,m_data(new TrackHitDataContainer() ) {
  
}

TrackHitCollection::~TrackHitCollection() {
  clear();
