...
JetParticleAssociationCollection::JetParticleAssociationCollection() : m_isValid(false), m_collectionID(0), m_entries() , m_rel_Jet(new std::vector<fcc::ConstJet>()), m_rel_Particle(new std::vector<fcc::ConstParticle>()),m_data(new JetParticleAssociationDataContainer() ) {
    m_refCollections.push_back(new std::vector<podio::ObjectID>());
  m_refCollections.push_back(new std::vector<podio::ObjectID>());

}

JetParticleAssociationCollection::~JetParticleAssociationCollection() {
  clear();
