...
TrackClusterHitsAssociationCollection::TrackClusterHitsAssociationCollection() : m_isValid(false), m_collectionID(0), m_entries() , m_rel_Cluster(new std::vector<fcc::ConstTrackCluster>()), m_rel_Hit(new std::vector<fcc::ConstTrackHit>()),m_data(new TrackClusterHitsAssociationDataContainer() ) {
    m_refCollections.push_back(new std::vector<podio::ObjectID>());
  m_refCollections.push_back(new std::vector<podio::ObjectID>());

}

TrackClusterHitsAssociationCollection::~TrackClusterHitsAssociationCollection() {
  clear();
