...
JetIntTagAssociationCollection::JetIntTagAssociationCollection() : m_isValid(false), m_collectionID(0), m_entries() , m_rel_Jet(new std::vector<fcc::ConstJet>()), m_rel_Tag(new std::vector<fcc::ConstIntTag>()),m_data(new JetIntTagAssociationDataContainer() ) {
    m_refCollections.push_back(new std::vector<podio::ObjectID>());
  m_refCollections.push_back(new std::vector<podio::ObjectID>());

}

JetIntTagAssociationCollection::~JetIntTagAssociationCollection() {
  clear();
