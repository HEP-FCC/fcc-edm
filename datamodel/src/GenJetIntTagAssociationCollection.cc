...
GenJetIntTagAssociationCollection::GenJetIntTagAssociationCollection() : m_collectionID(0), m_entries() ,m_rel_Jet(new std::vector<::fcc::ConstGenJet>()),m_rel_Tag(new std::vector<::fcc::ConstIntTag>()),m_refCollections(nullptr), m_data(new GenJetIntTagAssociationDataContainer() ) {
