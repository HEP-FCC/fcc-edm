...
GenVertexCollection::GenVertexCollection() : m_isValid(false), m_collectionID(0), m_entries() ,m_data(new GenVertexDataContainer() ) {
  
}

GenVertexCollection::~GenVertexCollection() {
  clear();
