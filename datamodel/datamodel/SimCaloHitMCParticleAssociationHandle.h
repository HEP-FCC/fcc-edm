...
public:
  ...
  SimCaloHitMCParticleAssociationHandle(const SimCaloHitMCParticleAssociationHandle& other) :
...
private:
  SimCaloHitMCParticleAssociationHandle(int index, unsigned containerID,  std::vector<SimCaloHitMCParticleAssociation>* container);
  int m_index;
