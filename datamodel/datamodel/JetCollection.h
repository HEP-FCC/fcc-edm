...
private:
  ...
  std::vector<fcc::ConstParticle>* m_rel_particles; ///< Relation buffer for read / write
  std::vector<std::vector<fcc::ConstParticle>*> m_rel_particles_tmp; ///< Relation buffer for internal book-keeping
