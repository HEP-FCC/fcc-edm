...
set(CPACK_PACKAGE_NAME "hep-fccedm")
set(CPACK_PACKAGE_DESCRIPTION "Datamodel library for the Future Circular Collider")
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Datamodel library for the Future Circular Collider")
set(CPACK_PACKAGE_VENDOR "HEP Software Foundation")
set(CPACK_DEBIAN_PACKAGE_RECOMMENDS "hep-podio, hep-root")
...
function(hsf_get_platform _output_var)
  ...
  elseif(CMAKE_SYSTEM_NAME MATCHES "Linux")
    ...
    if(EXISTS "/etc/os-release")
      ...
      find_program(fccedm_LSB_RELEASE_EXECUTABLE lsb_release
        DOC "Path to lsb_release program"
        )
      mark_as_advanced(fccedm_LSB_RELEASE_EXECUTABLE)
      if(fccedm_LSB_RELEASE_EXECUTABLE)
        # - ID
        execute_process(COMMAND ${fccedm_LSB_RELEASE_EXECUTABLE} -is
          OUTPUT_VARIABLE HSF_OS_ID
          OUTPUT_STRIP_TRAILING_WHITESPACE
          )
        string(TOLOWER ${HSF_OS_ID} HSF_OS_ID)
        # - Version
        execute_process(COMMAND ${fccedm_LSB_RELEASE_EXECUTABLE} -ir
          OUTPUT_VARIABLE HSF_OS_VERSION
          OUTPUT_STRIP_TRAILING_WHITESPACE
          )
        string(REGEX REPLACE "([a-z0-9]+)(\.|-|_)([a-z0-9]+).*" "\\1\\3" HSF_OS_VERSION ${HSF_OS_VERSION})
